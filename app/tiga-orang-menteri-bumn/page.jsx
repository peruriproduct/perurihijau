  ...
  return (
    <div className={`${styles.main_container} flex flex-col ${pops.className}`}>
      ...
      <div className={`${styles.content_container} flex flex-col gap-4`}>
        ...
        <div
          className={`${styles.person_identity_container} flex flex-col gap-2`}
        >
          <div
          ...
          >
            ...
            <span>
              Penanam &thinsp;<span className={`${styles.bold_text}`}>:</span>{" "}
              <span className={`${styles.bold_text}`}>Erick Thohir</span>
              <br />
              &emsp; &emsp; &emsp; &ensp; &ensp; &ensp;
              <span className={`${styles.think_text}`}>Menteri BUMN</span>
            </span>
          </div>
          <div
            className={`${styles.identity_with_icon} flex items-start gap-2`}
          >
            <span>
              <span className={`${styles.bold_text}`}>
                ...
                &thinsp;&thinsp; Heru Budi Hartono
              </span>
              <br />
              &emsp; &emsp; &emsp; &ensp; &ensp; &ensp; &ensp; &thinsp;{" "}
              <span className={`${styles.think_text}`}>
                Penjabat (Pj) Gubernur{" "}
              </span>
              <br />
              &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;
              <span className={`${styles.think_text}`}>DKI Jakarta</span>
            </span>
          </div>
          <div
            className={`${styles.identity_with_icon} flex items-start gap-2`}
          >
            <span>
              <span className={`${styles.bold_text}`}>
                &emsp; &emsp; &emsp; &ensp; &ensp; &ensp; &ensp;
                &thinsp;&thinsp; Dwina Septiani Wijaya
              </span>
              <br />
              &emsp; &emsp; &emsp; &ensp; &ensp; &ensp; &ensp; &thinsp;&thinsp;
              <span className={`${styles.think_text}`}>
...
export default TigaOrangMenteriBumn;
