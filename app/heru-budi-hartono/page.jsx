      ...
      <div className={`${styles.content_container} flex flex-col gap-4`}>
        ...
        >
          ...
          >
            ...
            <span>
              Penanam &nbsp;:{" "}
              <span className={`${styles.bold_text}`}> Heru Budi Hartono</span>
              <br />
              &emsp; &emsp; &ensp; &ensp; &ensp; &ensp;&ensp;Penjabat (Pj)
              Gubernur <br />
              &emsp;&emsp; &emsp; &emsp; &emsp;DKI Jakarta
            </span>
          </div>
          <div
